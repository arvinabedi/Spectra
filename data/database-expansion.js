...
(function (root) {
  ...
  /* قالبِ اتمیِ بلوک‌های این فایل — توضیحِ قرارداد در DB.blockStructures
     (data/database.js). موتورِ تقارن مولکول را از همین‌ها می‌سازد. */
  var STRUCT = {
    phenylene_o:     { smiles: "c1ccccc1",  attach: [0, 1] },   // اورتو
    butyl:           { smiles: "CCCC",      attach: [0] },      // همه‌جا نرمال-بوتیل است
    ...
    iodo:            { smiles: "I",         attach: [0] }
    /* عمداً بدونِ قالب:
         pyridyl        موقعیتِ اتصال اعلام‌نشده است و تقارن را عوض می‌کند
                        (۴-پیریدیل سه محیط دارد، ۲- و ۳-پیریدیل پنج تا).
                        برای حالتِ معلوم، pyridin_3yl هست.
         benzene_tri
         benzene_tetra  الگوی استخلاف اعلام‌نشده — نسخه‌های موقعیت‌دار
                        (benzene_123/124/135/…) را به‌جایشان به کار ببرید. */
  };
  if (DB.blockStructures) {
    Object.keys(STRUCT).forEach(function (k) {
      if (DB.blockStructures[k] === undefined) DB.blockStructures[k] = STRUCT[k];
    });
  }
  ...
  var COMPLETED_STUBS = [
    ...
    { field: "فیلد 161", name: "3-نیترو-اورتو-زایلن", en: "3-Nitro-o-xylene", formula: "C8H9NO2", ihd: 5, cls: "aromatic",
    ...
    { field: "فیلد 178", name: "9-متیل‌فلوئورن", en: "9-Methylfluorene", formula: "C14H12", ihd: 9, cls: "aromatic",
    ...
    { field: "فیلد 182", name: "اتیل 4-پیپریدون-1-کربوکسیلات", en: "Ethyl 4-piperidone-1-carboxylate", formula: "C8H13NO3", ihd: 3, cls: "ester",
    ...
    { field: "فیلد 185", name: "1-نیترونفتالین", en: "1-Nitronaphthalene", formula: "C10H7NO2", ihd: 8, cls: "aromatic",
      blocks: ["نفتیل", "نیترو"],
