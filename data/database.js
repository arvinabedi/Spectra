...
(function () {
  ...
  DB.c13BenzeneIncrements = [
    ...
    /* کتونِ آریلی. جدول این ردیف را نداشت، در حالی که استوفنون و مشتقاتش
       پرشمارترین خانوادهٔ کربونیلیِ بانک‌اند؛ بدونِ آن شیفتِ کربن‌های حلقهٔ
       هیچ آریل‌کتونی قابلِ پیش‌بینی نبود. */
    { sub: "COR",        fa: "کتون (آسیل)",      ipso: 9.3,  ortho: 0.2,  meta: 0.2,  para: 4.2, effect: "پذیرندهٔ رزونانسی (−M)؛ پارا بیش از همه دی‌شیلد می‌شود" }
  ];
