...
const DB = {
  ...
  reference: [
    ...
    { name:"تیمول/کارواکرول (ایزومر)", en:"Thymol/Carvacrol", formula:"C10H14O", ihd:4,
      ...
      chain:["isopropyl","phenyl","hydroxyl","methyl"], note:"⚠ ساختار سه‌استخلافی حلقوی؛ مونتاژ خطی تقریبی است. تلهٔ ایزومر موقعیتی: تفکیک تیمول از کارواکرول فقط با کوپلاژ متای ظریف (J=1-3Hz) و NOE بین OH و ایزوپروپیل ممکن است، نه با فرمول یا IR." },
