...
const CASES = [
  ...
  /* --- هندسهٔ آلکن: دو استخلافِ همسان روی یک کربنِ sp² ---
     پیوندِ دوگانه نمی‌چرخد، پس دو متیلِ جمینال سیس و ترانس می‌نشینند و
     دو محیطِ جدا می‌سازند، هرچند گراف قابلِ تعویضشان می‌بیند. مزیتیل
     اکسید شش سیگنالِ ¹³C واقعی دارد و موتور پیش‌تر پنج می‌شمرد.

     گاردِ روبه‌رو هم آزموده می‌شود: اگر کربنِ مقابل خودش متقارن باشد
     چیزی برای سیس/ترانس‌شدن نیست و نباید شکافی بیفتد — ایزوبوتیلن و
     ۲،۳-دی‌متیل-۲-بوتن دقیقاً همین حالت‌اند.

     هشدار برای آینده: RDKit در tools/test-inference.js رتبه‌بندیِ
     ساختاری می‌دهد و همین کوری را دارد، پس این ردیف‌ها تنها نگهبانِ
     این رفتارند. */
  ["CC(C)=CC(C)=O", "mesityl oxide (gem-methyl split)", "C6H10O", 6, 10, 2, 6, 4],
  // دو هیدروژنِ =CH₂ هم‌ارزند: کربنشان دو متیلِ یکسان دارد، پس دو پروتون
  // محیطِ یکسان می‌گیرند و شمارِ پروتون ۲ است نه ۳.
  ["CC(C)=C",       "isobutylene (no split: =CH2 symmetric)", "C4H8", 4, 8, 1, 3, 2],
  ["CC(C)=C(C)C",   "2,3-dimethyl-2-butene (no split)", "C6H12", 6, 12, 1, 2, 1],
  ["CC=C(C)C",      "2-methyl-2-butene (split)", "C5H10", 5, 10, 1, 5, 4],
  ["CC(C)=CCCC(C)=CCO", "geraniol skeleton (split)", "C10H18O", 10, 18, 2, 10, 9],
];
